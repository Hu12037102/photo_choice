...
<p align="center">
  <a href="https://github.com/Hu12037102/photo_choice/blob/master/docs/demo.mp4"><b>اضغط لتشغيل العرض التوضيحي</b></a><br>
...
`SandboxCleaner` وغيرها)، لكنها **تفاصيل تنفيذ داخلية**: لا يشملها الإصدار الدلالي وقد
