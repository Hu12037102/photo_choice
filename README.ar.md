...
| الكاميرا | بلاطة كاميرا اختيارية في الخلية الأولى (تُحفظ في معرض النظام) |
...
| `showCamera` | `Boolean` | `true` | عرض بلاطة الكاميرا في الخلية الأولى |
...
├── sample/
├── PRD.md                     # مواصفات المنتج الداخلية
